...
public class BesselCurveView extends View implements View.OnClickListener {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.save();
//        canvas.translate(widthView/2,heightView/2);
        ...
        RectF mCircleRectF=new RectF(0,-radius,heightView,radius);
        canvas.drawArc(oval,120,300,false,mCirclePaint);

        //画外圆圈
        mCirclePaint.setColor(mBesselCurveColor);
        canvas.drawArc(oval,120,mCircleNum,false,mCirclePaint);
//        canvas.drawArc(oval,
