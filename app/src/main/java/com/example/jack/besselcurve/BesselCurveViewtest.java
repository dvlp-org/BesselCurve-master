...
public class BesselCurveViewtest extends View implements View.OnClickListener {
    //时间
    private String time;
    //所有步数
    private int allStop;
    ...
    public BesselCurveViewtest(Context context) {
        this(context,null);
    }

    public BesselCurveViewtest(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public BesselCurveViewtest(Context context, AttributeSet attrs, int defStyleAttr) {
